...
public class NoticeMsg implements Serializable {
    ...
    public interface sys{
        ...
        static String groupCreateSuccess(String groupName, String groupKey){
            return "<p>来自<span style=\"color: #568fdc; margin: 0 10px;\">系统</span>消息：</p>\n" +
                    "<p>您的队伍<span style=\"color: #fec24f; margin: 0 10px;\">"+groupName+"</span>创建成功！</p>\n" +
                    "<p>队伍申请口令为<span style=\"color: #fec24f; margin: 0 10px;\">"+groupKey+"</span>快去通知你的小伙伴吧！</p>";
        }
    }
    ...
    public interface ind{
        ...
        static String groupNewApply(String groupName){
            return "<p>来自队伍<span style=\"color: #568fdc; margin: 0 10px;\">"+groupName+"</span>消息：</p>\n" +
        ...
        static String groupInvide(String groupName, String headerName, String phone){
            return "<p>来自队伍<span style=\"color: #568fdc; margin: 0 10px;\">"+groupName+"</span>消息：</p>\n" +
                    "<p>队长<span style=\"color: #fec24f; margin: 0 10px;\">"+headerName+"</span>邀请您加入队伍，请在我的队伍 -> 邀请消息中查看。</p>\n" +
                    "<p>如有疑问，请致电<span style=\"color: #fec24f; margin: 0 10px;\">"+phone+"</span></p>";
        }
        ...
        static String groupDisband(String groupName, String headerName, String phone){
            return "<p>来自队伍<span style=\"color: #568fdc; margin: 0 10px;\">"+groupName+"</span>消息：</p>\n" +
                    "<p>该队伍已被队长<span style=\"color: #fec24f; margin: 0 10px;\">"+headerName+"</span>解散请重新报名参赛。</p>\n" +
                    "<p>如有疑问，请致电<span style=\"color: #fec24f; margin: 0 10px;\">"+phone+"</span></p>";
        }
        /**
         * 来自队伍给我一个吻消息：
        ...
        static String groupSomeoneQuit(String groupName, String name, String phone){
            return "<p>来自队伍<span style=\"color: #568fdc; margin: 0 10px;\">"+groupName+"</span>消息：</p>\n" +
                    "<p>您的队员<span style=\"color: #fec24f; margin: 0 10px;\">"+name+"</span>，已退出队伍。</p>\n" +
                    "<p>如有疑问，请致电<span style=\"color: #fec24f; margin: 0 10px;\">"+phone+"</span></p>";
        }
        /**
         * 来自队伍给我一个吻消息：
        ...
        static String groupBequit(String groupName, String headerName, String phone){
            return "<p>来自队伍<span style=\"color: #568fdc; margin: 0 10px;\">"+groupName+"</span>消息：</p>\n" +
                    "<p>队长<span style=\"color: #fec24f; margin: 0 10px;\">"+headerName+"</span>将您移出队伍，请重新报名参赛。</p>\n" +
                    "<p>如有疑问，请致电<span style=\"color: #fec24f; margin: 0 10px;\">"+phone+"</span></p>";
        }
        /**
         * 来自队伍给我一个吻消息：
        ...
        static String groupBereject(String groupName, String headerName, String phone){
            return "<p>来自队伍<span style=\"color: #568fdc; margin: 0 10px;\">"+groupName+"</span>消息：</p>\n" +
                    "<p>队长<span style=\"color: #fec24f; margin: 0 10px;\">"+headerName+"</span>拒绝了您的申请。</p>\n" +
                    "<p>如有疑问，请致电<span style=\"color: #fec24f; margin: 0 10px;\">"+phone+"</span></p>";
        }
        /**
         * 来自队伍给我一个吻消息：
        ...
        static String groupBeAgree(String groupName, String headerName){
            return "<p>来自队伍<span style=\"color: #568fdc; margin: 0 10px;\">"+groupName+"</span>消息：</p>\n" +
                    "<p>队长<span style=\"color: #fec24f; margin: 0 10px;\">"+headerName+"</span>同意了您的申请，请在我的队伍中查看。</p>";
        }
        /**
        ...
        static String groupInviteBeeject(String userName,String phone){
            return "<p>来自用户<span style=\"color: #568fdc; margin: 0 10px;\">"+userName+"</span>消息：</p>\n" +
                    "<p>用户<span style=\"color: #fec24f; margin: 0 10px;\">"+userName+"</span>拒绝加入您的队伍<span style=\"color: #fec24f; margin: 0 10px;\">给我一个吻</span></p>\n" +
                    "<p>如有疑问，请致电<span style=\"color: #fec24f; margin: 0 10px;\">"+phone+"</span></p>";
        }
